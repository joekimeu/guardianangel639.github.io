...
import './operatingCommittee.css'; // New CSS file for this component

export default function OperatingCommittee() {
  const { darkMode } = useContext(DarkModeContext);

  return (
    <div className={`committee-page ${darkMode ? 'dark-mode' : 'light-mode'}`}>
      <Container className="text-center">
        <h1 className="page-title">Operating Committee</h1>
        <Row className="justify-content-center mt-5">
          <Col md={8}>
            ...
            <Card className="committee-card mb-5">
              <Card.Body>
                <Card.Title className="committee-title">Dora Boamoah</Card.Title>
                <Card.Subtitle className="committee-role">Office Manager</Card.Subtitle>
                <Card.Text className="committee-description">
                  Dora Boamoah is the Office Manager at Guardian Angel Health Agency.
                </Card.Text>
                <p className="contact-info">
